If what you are building is not SMOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOTH in the TUI, make it so. Smoothness, good feel, instant feedback, beautiful animations, fluid, thats what the goal is here with overseer.

# overseer

**overseer** — an always-on, buttery-smooth Ratatui TUI dashboard for a Mac Studio (M4 Max): system + Apple Silicon metrics, Claude Code usage, and Apple Music with karaoke-synced lyrics. Smoothness is the whole point — see line 1.
